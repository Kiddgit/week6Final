...
public class App {
	...
	public static void main(String[] args) {
		...
		Player player1 = new Player("Guy");
		Player player2 = new Player("Bud");
		...
		printTheScoreAndWinner(player1, player2);
	
	}

	private static void printTheScoreAndWinner(Player player1, Player player2) {
